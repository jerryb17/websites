    ...
    var retinaLogos = function() {
      ...
      var retina = window.devicePixelRatio > 1 ? true : false;
        ...
        if(retina) {
            ...
            $('.header .logo').find('img').attr({src:'../images/logo-regal-sales-corp.jpg',width:'217',height:'35'});   
        ...
        if(retina) {
            ...
            $('.footer .logo').find('img').attr({src:'../images/logo-regal-sales-corp.jpg',width:'217',height:'35'});   
